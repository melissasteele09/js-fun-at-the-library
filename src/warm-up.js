...
var sequel = `${title} and The Golden Bird.`;
...
function displayReadability() {
  if(pages < 1000) {
    return "I could read that in a day!";
  } else {
    return "Okay, maybe I could reath that in a day and a half"
  }
}
...
function diplayBookInfo() {
  if(isFavorite === true) {
    return `My favorite booke is ${title}!`
  } else {
...
var books = ["Book of Speculation", "The Universe", "Sphere", "The Last Tycoon", "Pirates"];


// Write the code to access the 3rd element of the Array, using bracket
// notation.
function numberThreeBook() {
  return books[2];
};
...
var belowTwoHundred = [39, 167, 199, 112, 47, 22, 85, 99, 175, 52, 69, 11];


// Write the code to access the 5th element of the array, using bracket notation.
function fifthPageNumber() {
